...
const faq = [
  { q: "Preciso saber programar para usar?", a: "Não! O FlowOS é completamente visual. Você cadastra seus produtos, configura as opções e o sistema funciona automaticamente." },
  ...
  { q: "Funciona no celular?", a: "Sim! O FlowOS é um PWA, funciona como um app no celular sem precisar baixar nada da Play Store." },
...
const testimonials = [
  { name: "Carlos Silva", role: "Pizzaria do Carlos", text: "Saí do marketplace e economizo R$ 800/mês. O FlowOS é muito mais simples e meus clientes adoram pedir pelo celular.", rating: 5, savings: "R$ 800/mês" },
  ...
  return (
    <div className="min-h-screen bg-black text-white overflow-x-hidden">
      ...
      <div className="pointer-events-none fixed inset-0 z-0">
        <div className="absolute -top-60 -left-60 h-[700px] w-[700px] rounded-full bg-[#1E7BFF]/[0.07] blur-[150px]" />
      ...
      <nav className={`fixed top-0 z-50 w-full transition-all duration-500 ease-out ${scrollY > 50 ? "border-b border-white/[0.08] bg-black/60 backdrop-blur-xl" : "bg-transparent"}`}>
        <div className="mx-auto flex h-[72px] max-w-[1440px] items-center justify-between px-5 md:px-[60px]">
          <div className="flex items-center gap-3">
            <FlowOSLogo size={56} className="h-12 md:h-14" />
          </div>
          <div className="flex items-center gap-4">
            ...
            <Link href="/cadastro" className="hidden sm:inline-flex">
              <span className="inline-flex h-[44px] items-center rounded-full bg-[#1E7BFF] px-6 text-[15px] font-semibold text-white transition-opacity hover:opacity-90 cursor-pointer">
        ...
        <div className="mx-auto max-w-[980px] text-center">
          ...
          <div className="mb-10 flex justify-center">
            <div className="relative">
              <div className="absolute inset-0 rounded-3xl bg-[#1E7BFF]/20 blur-[60px]" />
              <FlowOSLogo size={128} className="relative h-24 md:h-32" />
            </div>
          </div>
          ...
          <h1 className="text-[40px] md:text-[72px] font-semibold leading-[118%] md:leading-[105%] tracking-[-1px] md:tracking-[-2.4px]">
            A solução completa
            <br />
            <span className="bg-gradient-to-r from-[#1E7BFF] via-[#4D9AFF] to-[#7BB3FF] bg-clip-text text-transparent">pro seu estabelecimento.</span>
          </h1>
          ...
          <div className="mt-10 flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
            <Link href="/cadastro">
              <span className="inline-flex h-[58px] items-center gap-2 rounded-full bg-gradient-to-r from-[#1E7BFF] to-[#1666CC] px-10 text-[18px] font-semibold text-white transition-opacity hover:opacity-90 shadow-[0_0_40px_rgba(30,123,255,0.3)]">
                Testar 7 dias grátis
        ...
        <div className="mx-auto flex max-w-[1440px] items-center justify-center gap-12 md:gap-24 px-5">
          {[
            ...
            <div key={s.l} className="text-center">
              <p className="text-[28px] md:text-[36px] font-semibold tracking-[-1px] bg-gradient-to-r from-[#1E7BFF] to-[#4D9AFF] bg-clip-text text-transparent">{s.v}</p>
        ...
        <div className="mx-auto max-w-[1080px] px-5 md:px-[60px]">
          <div className="mb-16 md:mb-24">
            ...
            <h2 className="text-[32px] md:text-[56px] font-semibold leading-[115%] tracking-[-1px] md:tracking-[-2px] max-w-[800px]">
              ...
              <br />
              <span className="bg-gradient-to-r from-[#1E7BFF] to-[#4D9AFF] bg-clip-text text-transparent">Sem as taxas de comissão.</span>
            </h2>
          </div>
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            {features.map((f) => (
              <div key={f.title} className="group rounded-[16px] border border-white/[0.08] bg-white/[0.02] p-8 transition-all duration-500 hover:border-white/[0.15] hover:bg-white/[0.05]">
                <div className="mb-5 flex h-12 w-12 items-center justify-center rounded-[12px] bg-[#1E7BFF]/10">
                  <f.icon className="h-5 w-5 text-[#1E7BFF]" />
                </div>
        ...
        <div className="mx-auto max-w-[980px] px-5 md:px-[60px]">
          <div className="mb-16 md:mb-24 text-center">
            ...
            <h2 className="text-[32px] md:text-[56px] font-semibold leading-[115%] tracking-[-1px] md:tracking-[-2px]">
              ...
              <span className="bg-gradient-to-r from-[#1E7BFF] to-[#4D9AFF] bg-clip-text text-transparent">FlowOS</span>
            </h2>
          </div>
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <div className="relative rounded-[16px] border-2 border-[#1E7BFF]/40 bg-[#1E7BFF]/[0.06] p-8 shadow-[0_0_60px_rgba(30,123,255,0.08)]">
              <div className="absolute -top-3 right-6 rounded-full bg-gradient-to-r from-[#1E7BFF] to-[#4D9AFF] px-4 py-1.5 text-[12px] font-semibold text-white shadow-lg">
                Economia de R$ 15.000/ano
              </div>
              <div className="mb-6 flex items-center gap-3">
                <div className="flex h-10 w-10 items-center justify-center rounded-[10px] bg-[#1E7BFF]/15">
                  <Check className="h-5 w-5 text-[#1E7BFF]" />
                </div>
                <div>
                  <h3 className="text-[17px] font-semibold text-[#1E7BFF]">FlowOS</h3>
              ...
              <Link href="/cadastro" className="mt-6 block">
                <span className="flex h-[48px] w-full items-center justify-center rounded-full bg-[#1E7BFF] text-[15px] font-semibold text-white transition-opacity hover:opacity-90 cursor-pointer shadow-[0_0_30px_rgba(30,123,255,0.25)]">
                  Começar agora
        ...
        <div className="mx-auto max-w-[1080px] px-5 md:px-[60px]">
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              { title: "Cardápio", desc: "Categorias, produtos com fotos e preços", bg: "from-[#1E7BFF]/[0.08] to-orange-500/[0.04]", border: "border-[#1E7BFF]/[0.12]", icon: Store, iconColor: "text-[#1E7BFF]" },
        ...
        <div className="mx-auto max-w-[1080px] px-5 md:px-[60px]">
          <div className="mb-16 md:mb-24 text-center">
            ...
            <h2 className="text-[32px] md:text-[56px] font-semibold leading-[115%] tracking-[-1px] md:tracking-[-2px]">
              Mensalidade fixa.
              <br />
              <span className="bg-gradient-to-r from-[#1E7BFF] to-[#4D9AFF] bg-clip-text text-transparent">Sem surpresas.</span>
            </h2>
          </div>
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            {plans.map((plan) => (
              <div key={plan.name} className={`relative rounded-[16px] border p-7 transition-all duration-500 hover:scale-[1.02] ${plan.highlighted ? "border-[#1E7BFF]/40 bg-[#1E7BFF]/[0.06] shadow-[0_0_60px_rgba(30,123,255,0.08)]" : "border-white/[0.08] bg-white/[0.02] hover:border-white/[0.15]"}`}>
                {plan.badge && (
                  <div className="absolute -top-3 left-6 rounded-full bg-gradient-to-r from-[#1E7BFF] to-[#4D9AFF] px-4 py-1.5 text-[11px] font-semibold text-white">
                    {plan.badge}
                  </div>
                )}
                ...
                <ul className="mt-5 space-y-2.5">
                  {plan.features.map((f) => (
                    <li key={f} className="flex items-center gap-2.5 text-[14px] text-white/50">
                      <Check className="h-4 w-4 text-[#1E7BFF]" />
                      {f}
                    </li>
                  ))}
                </ul>
                <Link href="/cadastro" className="mt-6 block">
                  <span className={`flex h-[48px] w-full items-center justify-center rounded-full text-[15px] font-semibold transition-opacity hover:opacity-90 cursor-pointer ${plan.highlighted ? "bg-[#1E7BFF] text-white shadow-[0_0_30px_rgba(30,123,255,0.25)]" : "border border-white/10 text-white/60 hover:border-white/20 hover:text-white"}`}>
                    {plan.cta}
                  </span>
                </Link>
              </div>
      ...
      <section ref={cta.ref} className={`relative z-10 py-[120px] md:py-[200px] ${cta.className}`}>
        <div className="mx-auto max-w-[980px] px-5 md:px-[60px]">
          <div className="rounded-[24px] border border-[#1E7BFF]/20 bg-gradient-to-br from-[#1E7BFF]/[0.08] to-purple-600/[0.04] p-12 md:p-20 text-center">
            ...
            <h2 className="text-[36px] md:text-[64px] font-semibold leading-[110%] tracking-[-1.5px] md:tracking-[-2.4px]">
              ...
              <br />
              <span className="bg-gradient-to-r from-[#1E7BFF] to-[#4D9AFF] bg-clip-text text-transparent">Aqui é mensalidade fixa.</span>
            </h2>
            ...
            <div className="mt-10">
              <Link href="/cadastro">
                <span className="inline-flex h-[58px] items-center gap-2 rounded-full bg-gradient-to-r from-[#1E7BFF] to-[#1666CC] px-10 text-[18px] font-semibold text-white transition-opacity hover:opacity-90 shadow-[0_0_50px_rgba(30,123,255,0.3)]">
                  Testar 7 dias grátis
                  <ArrowRight className="h-5 w-5" />
                </span>
              </Link>
      ...
      <div className="fixed bottom-0 left-0 right-0 z-50 md:hidden">
        <Link href="/cadastro" className="block">
          <div className="flex h-[60px] items-center justify-center bg-gradient-to-r from-[#1E7BFF] to-[#1666CC] text-[16px] font-semibold text-white shadow-[0_-4px_20px_rgba(30,123,255,0.3)]">
            Testar 7 dias grátis
            <ArrowRight className="ml-2 h-4 w-4" />
          </div>
        </Link>
